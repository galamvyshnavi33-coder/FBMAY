...
public class GenericmethodC3 extends BaseClass3
{
	public static String captureScreenshot()throws IOException
	{
		...
		File destfile=new File("C:\\Users\\gvysh\\OneDrive\\Pictures\\Screenshots\\"+"ScreenCapture"+System.currentTimeMillis()+".png");
	...
	public static void sendkeys(String text,WebElement abc)
	{
	 ...
	 {
		 JavascriptExecutor js=(JavascriptExecutor)driver;
		 js.executeScript("arguments[0].click(0;",element);
	 }
	 ...
	 public static String alerts_gettext()
	 {
	 ...
	 public static void check_click(String Text,String text2,By input)throws InterruptedException
	 {
		 ...
		 {
			 if((Text .equals(values.get(i).getAttribute("value"))));
			 {
				 Thread.sleep(3000);
